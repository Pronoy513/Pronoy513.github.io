...
const Project = () => {
  ...
  return (
    ...
    <section className="c-space py-20 -my-20" id='work'>
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-zinc-900 rounded-xl">
          <div className="absolute top-0 right-0">
            ...
            <div className="p-3 z-[1] absolute top-0 right-0 backdrop-filter backdrop-blur-lg w-full h-96"></div>
          </div>
          ...
          <Canvas>
            ...
            <Center>
              <Suspense fallback={<CanvasLoader />}>
                <group scale={2} position={[-0.2, -3, 0]} rotation={[0, -0.1, 0]}>
